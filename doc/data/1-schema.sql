...
(
    ...
    `icd_name_pinyin`                     VARCHAR(1024)                                    NOT NULL COMMENT 'ICD名称拼音',
    ...
    `icd_optional_name_pinyin`            VARCHAR(1024)                                    NOT NULL DEFAULT '' COMMENT 'ICD疾病可选用名(仅中医)拼音',
    `icd_optional_name_pinyin_abbr`       VARCHAR(255)                                     NOT NULL DEFAULT '' COMMENT 'ICD疾病可选用名(仅中医)拼音首字母',
    `icd_alias_name`                      VARCHAR(512)                                     NOT NULL DEFAULT '' COMMENT 'ICD疾病别名, 多个以逗号分隔(仅中医)',
    `icd_alias_name_pinyin`               VARCHAR(2048)                                    NOT NULL DEFAULT '' COMMENT 'ICD疾病别名, 多个以逗号分隔(仅中医)拼音',
...
CREATE TABLE IF NOT EXISTS `hospitals` (
    ...
    `insurance_code`                 VARCHAR(32)                         NOT NULL DEFAULT '' COMMENT '医保定点机构编码',
    `uscc_code`                      VARCHAR(32)                         NOT NULL DEFAULT '' COMMENT '统一社会信用代码',
    `hospital_code`                  VARCHAR(32)                         NOT NULL COMMENT '医院机构登记号',
    ...
    `province`                       VARCHAR(50)                         NOT NULL DEFAULT '' COMMENT '所在省份名称',
    `city_id`                        BIGINT UNSIGNED                     NOT NULL DEFAULT 0 COMMENT '所在城市编码',
    `city`                           VARCHAR(50)                         NOT NULL DEFAULT '' COMMENT '所在城市名称',
    `county_id`                      BIGINT UNSIGNED                     NOT NULL DEFAULT 0 COMMENT '所在区县编码',
    `county`                         VARCHAR(50)                         NOT NULL DEFAULT '' COMMENT '所在区县名称',
    ...
    `summary`                        VARCHAR(255)                        NOT NULL DEFAULT '' COMMENT '医院简介',
    `description`                    TEXT                                NOT NULL COMMENT '医院详细描述',
