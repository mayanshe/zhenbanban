...
/**
 * Command Interface : 媒体资源
 *
 * @author zhangxihai 2025/8/26
 */
public interface MediaAmdCmdHandler {
    MediaDto handleAdd(MediaCreateCommand cmd);

    void handleModify(MediaModifyCommand cmd);

    void handleDestroy(Long key);
