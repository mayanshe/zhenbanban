...
/**
 * Command Interface : 自定义选项保存处理器
 *
 * @author zhangxihai 2025/8/24
 */
public interface OptionAmdCmdHandler extends IAmdCmdHandler<OptionAmdCommand, Long> {
    void handleModifyFixedOption(OptionAmdCommand command);
