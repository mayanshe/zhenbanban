...
@NoArgsConstructor
@AllArgsConstructor
public class SyndromeAmdCommand extends BaseCommand<Long> {
    ...
    private void setSyndromeNamePinyin(String value) {}

    public String getSyndromeNamePinyin() {
        return PinyinUtils.getPinyin(this.syndromeName);
    }

    private void setSyndromeNamePinyinAbbr(String value) {}
