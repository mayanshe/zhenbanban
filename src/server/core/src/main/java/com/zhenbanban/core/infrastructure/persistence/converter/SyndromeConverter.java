 ...
 */
@Mapper
public interface SyndromeConverter extends IConverter {
    SyndromeConverter INSTANCE = Mappers.getMapper(SyndromeConverter.class);
    ...
    SyndromePo toPo(Syndrome syndrome);
    ...
    SyndromePo updatePo(Syndrome syndrome, @MappingTarget SyndromePo po);
