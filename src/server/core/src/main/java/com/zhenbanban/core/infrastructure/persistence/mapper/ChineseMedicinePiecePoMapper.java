...
/**
 * Mybatis Mapper 接口：中药饮片
 *
 * @author zhangxihai 2025/08/31
 */
@Mapper
public interface ChineseMedicinePiecePoMapper extends PaginateMapper<ChineseMedicinePiecePo> {
    int insert(ChineseMedicinePiecePo chineseMedicinePiecePo);

    int update(ChineseMedicinePiecePo chineseMedicinePiecePo);

    int delete(Long id);

    ChineseMedicinePiecePo findById(Long id);
