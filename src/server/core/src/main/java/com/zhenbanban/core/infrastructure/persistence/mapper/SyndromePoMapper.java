...
/**
 * Mybatis Mapper 接口：中医证候
 *
 * @author zhangxihai 2025/09/01
 */
@Mapper
public interface SyndromePoMapper extends PaginateMapper<SyndromePo> {
    int insert(SyndromePo syndromePo);

    int update(SyndromePo syndromePo);

    int delete(Long id);

    SyndromePo findById(Long id);
