...
/**
 * Mybatis Mapper 接口: 中医治法
 *
 * @author zhangxihai 2025/09/01
 */
@Mapper
public interface TherapeuticPoMapper extends PaginateMapper<TherapeuticPo> {
    int insert(TherapeuticPo therapeuticPo);

    int update(TherapeuticPo therapeuticPo);

    int delete(Long id);

    TherapeuticPo findById(Long id);
